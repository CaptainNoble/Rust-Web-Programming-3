...
pub async fn extract_credentials(req: HttpRequest) -> Result<Credentials, NanoServiceError> {
    // Extract credentials from header and convert into a string
    ...
    // Basic auth starts with "Basic " string. If the string is not present, it is not basic auth.
    ...
    // We can decode our credials and convert result into string
    ...
    // Extract the password and email and return them
